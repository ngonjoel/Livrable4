...
SaveLifes est une appliccation qui permet aux donneurs de sang d'être repertoriés et enregistrés dans une base de données
L'application permet l'ouverture de compte d'utilisateur par des donneurs de sang
SaveLifes permet aux utilisateurs de trouver des donneurs de sang, selon le groupe sanguin recherché 
Cette application envoie des notifications aux donneurs enregistrés dans la base de données en cas de besoin de don de sang

NB: Certaines fontionalités ne sont pas encore implémentées 
	************************************
...
1) Rendez vous dans le dossier 'Livraison_4\doc'.

2) Double cliquez sur 'SaveLifes.jar'
...
Veuillez suivre les indications suivantes:
   ...
   Double cliquez sur 'SaveLifes.jar'